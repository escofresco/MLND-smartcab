...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ## Use appropriate params for testing
            self.epsilon = 0
            self.alpha = 0
        else:
            ## Update params
            # Update exponential decay N(t) = N(0) * e^(-rate*time)
            self.epsilon *= math.exp(-self.epsilon_decay*self.step)
    ...
    def get_maxQ(self, state):
        """ The get_maxQ function is called when the agent is asked to find the
            ...
            :returns: The maximum Q-value of all actions for a given state.
        """
    ...
    def choose_action(self, state):
        ...
        # When not learning or epsilon probability is too low, leave action as random
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            ...
            self.Q[state][action] *= 1 - self.alpha # Scale by 1-alpha
            self.Q[state][action] += reward * self.alpha # Update with reward
        return
